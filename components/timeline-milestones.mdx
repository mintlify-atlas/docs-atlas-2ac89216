...
description: "TimelineMilestones renders alternating left/right milestone cards along a vertical cyan gradient line, each animating into view with Framer Motion's whileInView."
---
...
| Export | Internal name | Year     | Theme / style |
|--------|---------------|----------|---------------|
| `fe`   | `P`           | 2018     | Polaroid-style photo card, rotated, healthcare imagery |
| `he`   | `S`           | 2020     | Yellow sticky-note card, retail & merchandising list |
| `ge`   | `F`           | 2021     | Slate card with 3-D perspective tilt, "The Curiosity Spark" |
| `ye`   | `a`           | 2022     | Dark terminal error card, "Transitioning to Code" |
| `ve`   | `b`           | Present  | Neon-lime recipe card, "Developer Potion" |

### Past Life: Healthcare (`fe` / `P`)
