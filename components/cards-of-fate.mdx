...
description: "CardsOfFate renders six tarot-inspired navigation cards on the home page, each with a scroll-triggered entrance and a 3-D perspective tilt on hover."
---
