...
description: "ProjectTiles renders three visually distinct project cards — HexagonTile, TerminalTile, and RunestoneTile — each with a title, stack badges, image, and flavor note."
---
