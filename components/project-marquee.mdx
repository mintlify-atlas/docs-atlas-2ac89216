...
description: "ProjectMarquee renders a continuously scrolling horizontal ticker of project names using Framer Motion's animate prop, styled with the coven neon color palette."
---
