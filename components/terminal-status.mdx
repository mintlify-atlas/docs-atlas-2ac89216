...
description: "TerminalStatus renders a mock terminal status block on the home page, displaying animated system-status-style text lines with a monospace font and neon-lime glow."
---
