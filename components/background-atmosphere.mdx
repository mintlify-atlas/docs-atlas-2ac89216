...
description: "BackgroundAtmosphere renders a fixed full-screen animated backdrop with glowing blobs and a floating alchemical glyph layer behind all page content."
---
