...
description: "HeroText animates the portfolio name letter-by-letter with Framer Motion stagger, then types out a tagline with a blinking cursor using useEffect and setInterval."
---
